...
int getVolume(){
  return (analogRead(pot_pin)+1)/40.96;
}

bool rewindButtonPress(){
...
// Old code minus volume display commented out for now
/*
if(digitalRead(button2_pin) ==1){
  delay(10);
  if(digitalRead(button2_pin) ==1){
